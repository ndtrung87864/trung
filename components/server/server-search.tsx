...
export const ServerSearch = ({
    ...
    const onClick = ({ id, type }: { id: string, type: "channel" | "member" | "agent"}) => {
        setOpen(false);
        if (type === "member") {
    ...
    return (
        <>
            ...
            >
                ...
                <p
                    className="font-semibold text-md text-zinc-500 dark:text-zinc-400
            ...
            <CommandDialog open={open} onOpenChange={setOpen}>
                <DialogTitle className="text-center font-semibold py-2" >Tìm kiếm Lớp và Thành viên</DialogTitle>
